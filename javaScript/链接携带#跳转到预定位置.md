...
鉴于上面的需求，通过`hash`(锚点)是可以简单实现上面的要求，个人当然希望能用浏览器及css解决的，就尽量解决，若是不行只能通过js来尽可能模拟出想要的效果。
...
github的代码 ![github](./../images/js/hash/1.png)
...
+ [chrome 记录位置1](https://cloud.tencent.com/developer/ask/35926)